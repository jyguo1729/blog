userCustom.onReady = function() {
    var style="body{color:blue}.theorem{display:block;margin:12px 0;font-style:italic}.theorem:before{content:'Theorem.';font-weight:700;fo";
    var style2=".theorem{display:block;margin:12px 0;font-style:italic}";
    var style3=".theorem:before{content:'Theorem.';font-weight:700;font-style:normal}";
